...
Most of these come down to network reality or how fptshop serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

fptshop rate-limits like any public site. fptshop already paces
...
Where a surface is gated, fptshop reads a cookie or token you supply
...
`fptshop`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what fptshop actually did
