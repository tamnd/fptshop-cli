...
// HTTP behaviour is covered in fptshop_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "fptshop://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("fptshop", "about")
	if err != nil || got.String() != "fptshop://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want fptshop://page/about", got.String(), err)
	}
}
